...
These files are generated by the extractor tool in `spec-option-extractor/`. See [specbuilderandextractor.md](specbuilderandextractor.md) for the full end-to-end process.
...
| Update the code inventory | Run the extractor | See [specbuilderandextractor.md](specbuilderandextractor.md) |
| Mark a C# class as a spec option | Your `.cs` file | Add `[SpecOption(...)]` — see [specbuilderandextractor.md](specbuilderandextractor.md) |
